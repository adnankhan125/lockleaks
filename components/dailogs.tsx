...
const Dailogs = () => {
      ...
      <div className="dailogs-login-slider-section d-flex flex-md-row flex-column">
        ...
        <div className="col-md-6 dailogs-login-box">
          ...
          <form className="w-100" style={{ maxWidth: 350 }}>
            ...
            <button type="submit" className="btn dailogs-btn-login mx-auto d-block">Login</button>
          </form>
        </div>

        {/* Right: Carousel */}
        <div className="col-md-6 dailogs-info-box p-0">
          <div id="dailogsCarousel" className="carousel slide h-100" data-bs-ride="carousel" data-bs-interval="3000">
            ...
            <div className="carousel-inner h-100 d-flex align-items-center">
              ...
              <div className="carousel-item active text-center px-4">
                ...
                <img src="/images/card.png" alt="Slide 1" className="img-fluid" style={{ maxWidth: '85%' }} />
              </div>

              <div className="carousel-item text-center px-4">
                <h4>Your Content Deserves the Best Protection.</h4>
                <p>We’re not just a leak removal service. Lock Leaks is a cybersecurity powerhouse, providing 
                  deep protection against leaks with continuous monitoring, real-time action, and proactive defense. 
                  We don’t stop at the surface — we secure your content everywhere.
</p>
               <img
  ...
  <h4>Claim Your</h4>
  <p>
    Follow us on social media and get 20% OFF your first service.<br />
    Stay updated on takedowns, tools & insights.
  </p>

  <div className="d-flex flex-column align-items-start justify-content-center mx-auto" style={{ maxWidth: '220px' }}>
    ...
    <div className="d-flex align-items-center mb-3">
      ...
      />
      <a href="https://x.com/lock_leaks" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'underline', color: '#000' }}>
        @lock_leaks
      </a>
    </div>
    ...
    <div className="d-flex align-items-center mb-3">
      <img
        ...
        style={{ width: '40px', height: '40px', borderRadius: '50%', marginRight: '10px' }}
      />
      <a href="https://instagram.com/lockleaks" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'underline', color: '#000' }}>
        @lockleaks
      </a>
    </div>
    ...
    <div className="d-flex align-items-center mb-3">
      <img
        ...
        style={{ width: '40px', height: '40px', borderRadius: '50%', marginRight: '10px' }}
      />
      <a href="https://tiktok.com/@lockleaks" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'underline', color: '#000' }}>
        @lockleaks
      </a>
    </div>
  </div>
  <p className="mt-4">Send proof via live chat to activate your discount.</p>
          <button className="chat-button">Live Chat<img
              src="/icons/Frame 122 1.svg"
              className="chat-pointer"
              alt="Pointer Icon"
            />
